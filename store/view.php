      ...
      <div class="container">
        ...
        <div class="site-section bg-light">
          <div class="container">
            ...
            <div class="bg-white py-4 mb-4">
              <div class="row mx-4 my-4 product-item-2 align-items-start">
                ...
                <div class="col-md-5 ml-auto product-title-wrap">
                  ...
                  <p>
                    <a href="view.php" class="btn btn-black btn-outline-black rounded-0 d-block mb-2 mb-lg-0 d-lg-inline-block">View Details</a>
            ...
            <div class="bg-white " style="padding:5%">
              <div class="row ">


                <div class="   ">

                  <h3 class="text-black font-weight-bold">Detalhe Sobre o Produto</h3>
                  ...
                  <div class=" ">
                    <h3 class="text-black font-weight-bold h5">Observação sobre o Produto:</h3>

                  </div>

                  <div class="col-12">
                    O que é um perfil nível silver?

                    Um freelancer Silver é um freelancer com pelo menos 1 projeto completo com sucesso. Isso significa que ele já tem suas primeiras estrelas e sua carreira profissional na Workana começou bem. Não se esqueça de checar a sua reputação e perfil para escolher este profissional nas próximas contratações.
          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-12 text-left">
                <h3 class="section-sub-title">Imagens do Produto</h3>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 pull-left" data-action="zoom" data-aos="fade" data-aos-delay="100">
                <div class="person text-center">

                  <img src="images/person_2.jpg" alt="Image" class="img-fluid rounded w-100 mb-3">
              ...
              <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                <div class="person text-center">
                  <img src="images/person_3.jpg" alt="Image" class="img-fluid rounded w-100 mb-3">
              ...
              <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                <div class="person text-center">
                  <img src="images/person_4.jpg" alt="Image" class="img-fluid rounded w-100 mb-3">
                </div>
              </div>
    ...
    -->
        ...
        <div class="site-section bg-light" id="contact-section">
          <div class="container">
            <div class="row mb-5">
              <div class="col-12 text-center">
                <h3 class="section-sub-title">Saber Mais Sobre este Produto</h3>
                <h3 class="section-title  ">Prencha os Campos Abaixo , com as pergutas ou Duvidas Sobre o Produto.</h3>
              </div>
            </div>
